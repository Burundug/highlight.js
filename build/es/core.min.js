...
;const i=k.case_insensitive?t[0].toLowerCase():t[0],s=l(v,i);if(s){const[e,o]=s
;if(R.addText(n),
n="",c[i]=(c[i]||0)+1,c[i]<=7&&(j+=o),e.startsWith("_"))n+=t[0];else{
...
const t=e[0],i=n.substring(e.index),s=b(v,e,i);if(!s)return Q;const o=v
;v.endScope&&v.endScope._wrap?(u(),
d(t,v.endScope._wrap)):v.endScope&&v.endScope._multi?(u(),
h(v.endScope,e)):o.skip?A+=t:(o.returnEnd||o.excludeEnd||(A+=t),
u(),o.excludeEnd&&(A=t));do{
v.scope&&R.closeNode(),v.skip||v.subLanguage||(j+=v.relevance),v=v.parent
}while(v!==s.parent);return s.starts&&f(s.starts,e),o.returnEnd?0:t.length}
let y={};function w(i,o){const a=o&&o[0];if(A+=i,null==a)return u(),0
...
u(),i.returnBegin||i.excludeBegin||(A=n)),f(i,e),i.returnBegin?0:n.length})(o)
;if("illegal"===o.type&&!s){
const e=Error('Illegal lexeme "'+a+'" for mode "'+(v.scope||"<unnamed>")+'"')
;throw e.mode=v,e}if("end"===o.type){const e=_(o);if(e!==Q)return e}
if("illegal"===o.type&&""===a)return o.index===n.length||(A+="\n"),1
...
;const N=Z(k);let S="",v=o||N;const M={},R=new p.__emitter(p);(()=>{const e=[]
...
context:n.slice(I-100,I+100),mode:t.mode,resultSoFar:S},_emitter:R};if(r)return{
...
}),S("after:highlightElement",{el:e,result:o,text:i})}let y=!1;function w(){
...
}function S(e,t){const n=e;o.forEach(e=>{e[n]&&e[n](t)})}Object.assign(n,{
