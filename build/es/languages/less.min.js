...
}))(a),s=n,c="[\\w-]+",d="("+c+"|@\\{"+c+"\\})",b=[],m=[],g=e=>({
className:"string",begin:"~?"+e+".*?"+e}),p=(e,t,i)=>({className:e,begin:t,
relevance:i}),f={$pattern:/[a-z-]+/,keyword:"and or not only",
attribute:t.join(" ")},h={begin:"\\(",end:"\\)",contains:m,keywords:f,
relevance:0}
;m.push(a.C_LINE_COMMENT_MODE,a.C_BLOCK_COMMENT_MODE,g("'"),g('"'),l.CSS_NUMBER_MODE,{
begin:"(url|data-uri)\\(",starts:{className:"string",end:"[\\)\\n]",
excludeEnd:!0}
},l.UNICODE_RANGE,l.HEXCOLOR,h,p("variable","@@?"+c,10),p("variable","@\\{"+c+"\\}"),p("built_in","~?`[^`]*?`"),{
className:"attribute",begin:c+"\\s*:",end:":",returnBegin:!0,excludeEnd:!0
},l.IMPORTANT,{beginKeywords:"and not"},l.FUNCTION_DISPATCH);const u=m.concat({
begin:/\{/,end:/\}/,contains:b}),k={beginKeywords:"when",endsWithParent:!0,
contains:[{beginKeywords:"and not"}].concat(m)},v={begin:d+"\\s*:",
returnBegin:!0,end:/[;}]/,relevance:0,contains:[{begin:/-(webkit|moz|ms|o)-/
},l.CSS_VARIABLE,{className:"attribute",begin:"\\b("+r.join("|")+")\\b",
end:/(?=:)/,starts:{endsWithParent:!0,illegal:"[<=$]",relevance:0,contains:m}}]
},y={className:"keyword",
begin:"@(import|media|charset|font-face|(-[a-z]+-)?keyframes|supports|document|namespace|page|viewport|host)\\b",
starts:{end:"[;{}]",keywords:f,returnEnd:!0,contains:m,relevance:0}},w={
...
end:/\)/,relevance:0,contains:u},{begin:"!important"},l.FUNCTION_DISPATCH]},E={
begin:c+":(:)?"+`(${s.join("|")})`,returnBegin:!0,contains:[x]}
;return b.push(a.C_LINE_COMMENT_MODE,a.C_BLOCK_COMMENT_MODE,y,w,E,v,x,k,l.FUNCTION_DISPATCH),
{name:"Less",case_insensitive:!0,illegal:"[=>'/<($\"]",contains:b}}})()
