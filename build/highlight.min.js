...
},G=Error();function K(e,t,{key:n}){let i=0;const s=e[n],o={},r={}
;for(let e=1;e<=t.length;e++)r[e+i]=s[e],o[e+i]=!0,i+=p(t[e-1])
;e[n]=r,e[n]._emit=o,e[n]._multi=!0}function F(e){(e=>{
...
;[I,B,F,D].forEach(e=>e(o,r)),e.compilerExtensions.forEach(e=>e(o,r)),
o.__beforeBegin=null,[T,L,P].forEach(e=>e(o,r)),o.isCompiled=!0;let c=null
;return"object"==typeof o.keywords&&o.keywords.$pattern&&(o.keywords=Object.assign({},o.keywords),
c=o.keywords.$pattern,
delete o.keywords.$pattern),c=c||/\w+/,o.keywords&&(o.keywords=C(o.keywords,e.case_insensitive)),
...
console.log("ok");const J=n,Y=i,Q=Symbol("nomatch"),ee=n=>{
...
;const i=k.case_insensitive?t[0].toLowerCase():t[0],s=l(S,i);if(s){const[e,o]=s
;if(R.addText(n),
n="",c[i]=(c[i]||0)+1,c[i]<=7&&(A+=o),e.startsWith("_"))n+=t[0];else{
...
const t=e[0],i=n.substring(e.index),s=b(S,e,i);if(!s)return Q;const o=S
...
u(),o.excludeEnd&&(j=t));do{
S.scope&&R.closeNode(),S.skip||S.subLanguage||(A+=S.relevance),S=S.parent
}while(S!==s.parent);return s.starts&&f(s.starts,e),o.returnEnd?0:t.length}
let _={};function w(i,o){const a=o&&o[0];if(j+=i,null==a)return u(),0
;if("begin"===_.type&&"end"===o.type&&_.index===o.index&&""===a){
if(j+=n.slice(o.index,o.index+1),!r){const t=Error(`0 width match regex (${e})`)
;throw t.languageName=e,t.badRule=_.rule,t}return 1}
if(_=o,"begin"===o.type)return(e=>{
const n=e[0],i=e.rule,s=new t(i),o=[i.__beforeBegin,i["on:begin"]]
;for(const t of o)if(t&&(t(e,s),s.isMatchIgnored))return m(n)
;return i.skip?j+=n:(i.excludeBegin&&(j+=n),
u(),i.returnBegin||i.excludeBegin||(j=n)),f(i,e),i.returnBegin?0:n.length})(o)
;if("illegal"===o.type&&!s){
const e=Error('Illegal lexeme "'+a+'" for mode "'+(S.scope||"<unnamed>")+'"')
;throw e.mode=S,e}if("end"===o.type){const e=y(o);if(e!==Q)return e}
if("illegal"===o.type&&""===a)return o.index===n.length||(j+="\n"),1
;if(T>1e5&&T>3*o.index)throw Error("potential infinite loop, way more iterations than matches")
;return j+=a,a.length}const k=O(e)
;if(!k)throw z(a.replace("{}",e)),Error('Unknown language: "'+e+'"')
;const v=Z(k);let N="",S=o||v;const M={},R=new p.__emitter(p);(()=>{const e=[]
...
context:n.slice(I-100,I+100),mode:t.mode,resultSoFar:N},_emitter:R};if(r)return{
...
}),N("after:highlightElement",{el:e,result:o,text:i})}let _=!1;function w(){
...
}function N(e,t){const n=e;o.forEach(e=>{e[n]&&e[n](t)})}Object.assign(n,{
...
r=!1},n.safeMode=()=>{r=!0},n.versionString="11.11.1",n.regex={concat:h,
